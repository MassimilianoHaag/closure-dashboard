...
const prototypeFiles = import.meta.glob('../../../../04_Prototype/**/*.md', { query: '?raw', import: 'default', eager: true })
...
<template>
  <div class="sticky top-10">
    ...
    <div>
      ...
      <StageRow name="Prototype" :count="nk(prototypeFiles)" :links="[{ label: 'Prototype Overview', href: './prototype.html' }, { label: 'User Flow', href: './flow.html' }, { label: 'Live App ↗', href: 'https://closure-prototype.vercel.app/', external: true }]" />
      <StageRow name="Presentation" :count="1" color="green" :links="[{ label: 'Deck', href: './presentation.html' }]" />
    </div>
  </div>
</template>
